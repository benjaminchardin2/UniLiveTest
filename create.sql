...
create table bet (id bigint not null, state integer, date timestamp, customer_id bigint, odd decimal(19,2), amount decimal(19,2), selection_id bigint not null, primary key (id));
create table customer (id bigint not null, balance decimal(19,2), login integer, version bigint, primary key (id));
